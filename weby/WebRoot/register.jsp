            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    ...
                    <div class="login-register-wrapper">
                        <h4 class="title">登录您的账户</h4>
                        <p>已有账户？ <a href="login.jsp">请改为登录！</a></p>
                        <form action="registerServlet" method="post" name=form>
                            ...
                            <div class="single-form">
                                ...
                                <label for="receive"><span></span> 接受合作伙伴的优惠</label>
                            </div>
                            <div class="single-form">
                                <input type="checkbox" id="newsletter">
                                <label for="newsletter"> <span></span> 注册我们的时事通讯 <br> 立即订阅我们的时事通讯，随时了解最新产品系列、最新样书和独家优惠。</label>
                            </div>
                            <div class="single-form">
                                <button class="btn btn-primary btn-hover-dark rounded-pill" type="submit" name="g">注册</button>
                            </div>
                        </form>
                        <div class="single-form">
                                <label>注册反馈：</label>
