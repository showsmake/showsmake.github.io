...
<jsp:useBean id="usersBean" class="mybean.data.TradeRegister" scope="request"/>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="page-banner section">
        <div class="container">
            <div class="page-banner-wrapper text-center">
                <h2 class="title">店铺注册</h2>
                <ul class="breadcrumb justify-content-center">
                    <li class="breadcrumb-item"><a href="index.html">首页</a></li>
                    <li class="breadcrumb-item active">店铺</li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    ...
                    <div class="login-register-wrapper">
                        ...
                        <form action="registerTradeServlet" method="post" name=form>
                            ...
                            <div class="single-form">
                                <button class="btn btn-primary btn-hover-dark rounded-pill" type="submit" name="g">Register</button>
                            </div>
                        </form>
                        <div class="single-form">
                                <label>注册反馈：</label>
                                <jsp:getProperty name="usersBean"  property="backNews" />
                        </div>
                        <div class="single-form">
                                <label>用户名称：</label>
                                <jsp:getProperty name="usersBean" property="logname"/>
                        </div>
                        <div class="single-form">
                                <label>姓名：</label>
                                <jsp:getProperty name="usersBean" property="realname"/>
                        </div>
                        <div class="single-form">
                                <label>地址：</label>
                                <jsp:getProperty name="usersBean" property="address"/>
                        </div>
                        <div class="single-form">
                                <label>电话：</label>
                                <jsp:getProperty name="usersBean" property="phone"/>
                        </div>
                    </div>
                    <!-- Login & Register End -->
                </div>
