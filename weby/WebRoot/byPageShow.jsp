<%@ page language="java" contentType="text/html; charset=GB18030" import="mybean.data.DataByPage" import="com.sun.rowset.*"
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    ...
                    <div class="login-register-wrapper">
                        ...
                        <table class="table">
                        <tr>
                          <th ><label>标识号</label></th>
                          <th><label>商品名称</label></th>
                          <th><label>店铺</label></th>
                          <th><label>价格</label></th>
                          <th><label>查看详情</label></th>
                          <th><label>添加到购物车</label></th>
                          </tr>
                          <jsp:setProperty name="dataBean" property="pageSize" param="pageSize"/>
                          <jsp:setProperty name="dataBean" property="currentPage" param="currentPage"/>
                        <%    
                        DataByPage dataBase = (DataByPage)session.getAttribute("dataBean");
                        String[][] a = dataBase.getA();
                        if(a==null) {
                           out.print("没有任何查询信息，无法浏览");
                           return;  
                        }
                        int totalRecord=a.length;
                        ...
                        for(int i=1;i<=pageSize&&boo;i++) { 
        	              String number=a[index-1][0];
                          String name=a[index-1][1];
                          String maker=a[index-1][2];
                          String price=a[index-1][3];
                          String goods =
                          "("+number+","+name+","+maker+
