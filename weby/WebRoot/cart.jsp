            ...
            <div class="cart-wrapper">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="product-name">
                                    <a class="name" href="product-details-right-sidebar.html">露西达无袖连衣裙</a>
                                </td>
                ...
                <div class="cart-btn">
                    <div class="cart-btn-left">
                        <a href="#" class="btn btn-dark btn-hover-primary rounded-pill">继续购物</a>
                    </div>
                    <div class="cart-btn-right">
                        <a href="#" class="btn btn-outline-dark btn-hover-dark rounded-pill">清里购物车</a>
                        <a href="#" class="btn btn-outline-dark btn-hover-dark rounded-pill">更新购物测</a>
                    </div>
                </div>
            </div>
            <!-- Cart End -->
                    ...
                    <div class="cart-shipping">
                        ...
                        <div class="cart-form">
                            ...
                            <form action="#">
                                <div class="single-select2">
                                    <div class="form-select2">
                                        <select class="select2">
                                            ...
                                            <option value="1">孟加拉国</option>
                                            <option value="2">加拿大</option>
                                            <option value="3">哥伦比亚</option>
                                            <option value="4">印度尼西亚</option>
                                            <option value="5">意大利</option>
                                            <option value="6">巴基斯坦</option>
                                ...
                                <div class="single-select2">
                                    <div class="form-select2">
                                        <select class="select2">
                                            ...
                                            <option value="BAG">伯格哈特</option>
                                            <option value="BAN">班多尔班县</option>
                                            <option value="BAR">博尔古纳</option>
                                            <option value="BARI">巴里萨尔</option>
                                            <option value="BHO">博拉</option>
                                            <option value="BOG">博格拉</option>
                                            <option value="BRA">婆罗门巴里亚</option>
                                            <option value="CHA">坚德布尔</option>
                                            <option value="CHI">吉大港</option>
                                            <option value="CHU">朱瓦当加</option>
                                            <option value="COM">科米拉</option>
                                            <option value="COX">科克斯巴扎尔</option>
                                            <option value="DHA">达卡</option>
                                            <option value="DIN">迪纳杰普尔</option>
                                            <option value="FAR">福里德布尔 </option>
                                            <option value="FEN">费尼</option>
                                            <option value="GAI">盖班达</option>
                                            <option value="GAZI">加济布尔</option>
                                            <option value="GOP">戈巴尔甘尼</option>
                                            <option value="HAB">哈比甘杰</option>
                                            <option value="JAM">杰马勒布尔</option>
                                            <option value="JES">杰西</option>
                                            <option value="JHA">恰洛加蒂县</option>
                                            <option value="JHE">切尼达</option>
                                            <option value="JOY">焦伊布尔哈德</option>
                                            <option value="KHA">格拉哈里</option>
                                            <option value="KHU">库尔纳</option>
                                            <option value="KIS">吉绍尔甘杰</option>
                                            <option value="KUR">格拉姆</option>
                                            <option value="KUS">库什蒂亚</option>
                                            <option value="LAK">拉克希米普尔</option>
                                            <option value="LAL">拉尔莫尼哈德</option>
                                            <option value="MAD">马达里普尔</option>
                                            <option value="MAG">马古拉</option>
                                            <option value="MAN">马尼格甘杰</option>
                                            <option value="MEH">梅赫普尔</option>
                                            <option value="MOU">姆维巴扎</option>
                                            <option value="MUN">蒙希甘杰</option>
                                            <option value="MYM">迈门辛格</option>
                                            <option value="NAO">内奥冈</option>
                                            <option value="NAR">纳瑞尔</option>
                                            <option value="NARG">纳拉扬甘杰</option>
                                            <option value="NARD">纳辛迪</option>
                                            <option value="NAT">纳托尔</option>
                                            <option value="NAW">纳瓦布甘杰</option>
                                            <option value="NET">内特拉科纳</option>
                                            <option value="NIL">尼尔帕马里</option>
                                            <option value="NOA">诺阿卡利</option>
                                            <option value="PAB">巴布纳</option>
                                            <option value="PAN">班乔戈尔</option>
                                            <option value="PAT">博杜阿卡利</option>
                                            <option value="PIR">皮罗杰普尔</option>
                                            <option value="RAJB">拉杰巴里</option>
                                            <option value="RAJ">拉杰沙希</option>
                                            <option value="RAN">兰加马蒂</option>
                                            <option value="RANP">朗普</option>
                                            <option value="SAT">萨德基拉</option>
                                            <option value="SHA">沙里亚德布尔</option>
                                            <option value="SHE">谢尔普尔</option>
                                            <option value="SIR">希拉吉干</option>
                                            <option value="SUN">苏纳姆甘杰</option>
                                            <option value="SYL">西尔赫特</option>
                                            <option value="TAN">坦盖尔</option>
                                            <option value="THA">塔古尔冈</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="single-form">
                                    <button class="btn btn-dark btn-hover-primary rounded-pill">更新总数</button>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="cart-shipping">
                        ...
                        <div class="cart-form">
                            <form action="#">
                                <div class="single-form">
                                    <input type="text" placeholder="输入您的优惠券代码..">
                                </div>
                                <div class="single-form">
                                    <button class="btn btn-dark btn-hover-primary rounded-pill">使用优惠券</button>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="cart-totals">
                                        ...
                                        <td>
                                            <ul class="shipping-list">
                                                <li class="radio">
                                                    ...
                                                    <label for="radio1"><span></span> 统一费率</label>
                                                </li>
                                                <li class="radio">
                                                    <input type="radio" name="shipping" id="radio2">
                                                    <label for="radio2"><span></span> 免运费</label>
                                                </li>
                                                <li class="radio">
                                                    <input type="radio" name="shipping" id="radio3">
                                                    <label for="radio3"><span></span> 面交</label>
                                                </li>
                                            </ul>
                                        </td>
                                    </tr>
                        ...
                        <div class="cart-total-btn d-grid">
                            <a href="#" class="btn btn-dark btn-hover-primary rounded-pill">继续结帐</a>
                        </div>
                    </div>
                    <!-- Cart Totals End -->
                </div>
