...
<jsp:useBean id="loginsBean" class="mybean.data.TradeLogin" scope="session"/>
<!DOCTYPE html>
<html lang="en">
...
<body>
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col">
                        <div class="header-top-info">
                            <p><a href="#">您的订单</a></p>
                            <p>致电 <a href="tel:+12345879541"> +12345 879 541</a></p>
                        </div>
                    </div>
                    <!-- Header info End -->
    ...
    <!-- Search End -->
     ...
     <!-- Page Banner Start -->
    <div class="page-banner about-banner section">
        <div class="container">
            <div class="page-banner-wrapper text-center">
                <h2 class="title">我的店铺</h2>
                <ul class="breadcrumb justify-content-center">
                    <li class="breadcrumb-item"><a href="index.html">主页</a></li>
                    <li class="breadcrumb-item active">我的店铺</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="section section-padding-02 mt-n1">
                        ...
                        <table class="table">
    <%  if(loginsBean.getLogname()==null){
                   response.sendRedirect("tradelogin.jsp");//重定向到登录页面
                }
                else {
                       boolean b =loginsBean.getLogname()==null||
                       loginsBean.getLogname().length()==0;
                if(b)
                       response.sendRedirect("tradelogin.jsp");//重定向到登录页面
                }
                Connection con;
                Statement sql; 
                ResultSet rs;
                out.print("商铺中的物品：<table border=2>");
                ...
                try{
                	...
                	String s = "SELECT storename FROM userTrade where logname= '"+loginsBean.getLogname()+"'";
                    ResultSet q = sql.executeQuery(s);
                    String x="";
                    while(q.next()){
                        x = q.getString(1);
                    }
                	String cdn="SELECT number,name,made,price,mess,pic,id FROM goods where made= '"+x+"'";
                	rs=sql.executeQuery(cdn);
                    out.print("<tr>");
                      out.print("<th width=100>"+"商品编号");
                      out.print("<th width=100>"+"商品名称");
                      out.print("<th width=100>"+"店铺名称");
                      out.print("<th width=100>"+"价格");
                      out.print("<th width=100>"+"详细描述");
                      out.print("<th width=100>"+"商品图片");
                      out.print("<th width=100>"+"商品ID");
                    out.print("</tr>");
                    while(rs.next()){
                        out.print("<tr>");
                          ...
                          out.print("<td >"+"<img src='assets/images/"+rs.getString(6)+"' width=260 height=200 ></img>"+"</td>");
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    ...
                    <div class="login-register-wrapper">
                       ...
                       <a href="goodsAdd.jsp"><button class="btn btn-primary btn-hover-dark rounded-pill">增加商品</button></a><br>
                       <a href="goodsDelete.jsp"><button class="btn btn-primary btn-hover-dark rounded-pill">减少商品</button></a>
                       </div>
                    </div>
                    <!-- Login & Register End -->
                </div>
