...
<body>
   ...
   String uri="jdbc:mysql://localhost:3306/shops";
   try{ 
     con=DriverManager.getConnection(uri,"root","2002031500");
     sql=con.createStatement();
     String cdn=
     "SELECT * FROM goods where number = '"+numberID+"'";
     ...
     while(rs.next()){
       ...
       "("+number+","+name+","+maker+
        ...
        out.print("<td>"+detailMess+"</td>");
        out.print("<td>"+button+"</td>");
        out.print("</tr>");
     } 
     out.print("</table>");
     out.print("产品图片:<br>");
     String pic ="<img src='assets/images/"+picture+"' width=260 height=200 ></img>";
     out.print(pic); //产片图片
     con.close();
  }
