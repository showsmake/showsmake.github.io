    ...
    <div class="page-banner about-banner section">
        <div class="container">
            <div class="page-banner-wrapper text-center">
                <h2 class="title">删除商品</h2>
                <ul class="breadcrumb justify-content-center">
                    <li class="breadcrumb-item"><a href="index.html">主页</a></li>
                    <li class="breadcrumb-item active">删除商品</li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    ...
                    <div class="login-register-wrapper">
                        <h4 class="title">库存减少,请输入要删除商品的信息</h4>
                        <form action="goodsDeleteServlet" method="post">
                            <div class="single-form">
                               <label>商品编号 <span>*</span></label>
