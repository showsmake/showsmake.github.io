        ...
        <div class="container">
            <div class="page-banner-wrapper text-center">
                ...
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li class="breadcrumb-item active">商家登录</li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    ...
                    <div class="login-register-wrapper">
                        ...
                        <form action="loginTradeServlet" method="post">
                            ...
                            <div class="single-form">
                                ...
                                <label for="remember"><span></span> 記住我</label>
                            </div>
                            <div class="single-form">
                                <button class="btn btn-primary btn-hover-dark rounded-pill" type="submit">登录</button>
                            </div>
                        </form>
                        <p><a href="#">丢失密码?</a></p>
                        <p>没有账户? <a href="traderegister.jsp">在这里创建一个.</a></p>
                        <div class="single-form">
                                <label>登录反馈信息：</label>
                                <jsp:getProperty name="loginsBean"  property="backNews" />
                        </div>
                        <div class="single-form">
                                <label>登录名称：</label>
                                <jsp:getProperty name="loginsBean" property="logname"/>
                        </div>
                    </div>
                    <!-- Login & Register End -->
                </div>
