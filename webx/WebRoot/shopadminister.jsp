...
<jsp:useBean id="loginaBean" class="mybean.data.AdministerLogin" scope="session"/>
<!DOCTYPE html>
...
<body>
    ...
    <section class="main-content-area">
        <div class="container">
            ...
            <h3>您的商店</h3>
            <%  if(loginaBean.getLogname()==null){
                   response.sendRedirect("administerlogin.jsp");//重定向到登录页面
                }
                else {
                       boolean b =loginaBean.getLogname()==null||
                       loginaBean.getLogname().length()==0;
                if(b)
                       response.sendRedirect("administerlogin.jsp");//重定向到登录页面
                }
                Connection con;
                Statement sql; 
                ResultSet rs;
                out.print("店家在线情况：<table border=2>");
                ...
                try{
                	...
                	String s = "SELECT * FROM loging";
                	ResultSet q = sql.executeQuery(s);
                	out.print("<table border=2>");
                    out.print("<tr>");
                      out.print("<th width=100>"+"店家用户名");
                      out.print("<th width=100>"+"在线情况");
                    out.print("</tr>");
                	while(q.next()){
                        out.print("<td >"+q.getString(1)+"</td>"); 
                        out.print("<td >"+"在线"+"</td>");
                        out.print("</tr>") ; 
                	}
            ...
            %>
            <a href="tradeDelete.jsp"><button>下线店家</button></a>
