...
<body>
    ...
    <section class="main-content-area">
        <div class="container">
                ...
                try{
                    ...
                    while(rs.next()){
                        out.print("<tr>");
                          ...
                          out.print("<td >"+"<img src='img/"+rs.getString(6)+"' width=260 height=200 ></img>"+"</td>");
            ...
            %>
            <a href="goodsAdd.jsp"><button>增加商品</button></a><br>
            <a href="goodsDelete.jsp"><button>减少商品</button></a>
