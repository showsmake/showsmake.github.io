...
<jsp:useBean id="usersBean" class="mybean.data.Register" scope="request"/>
<!DOCTYPE html>
    ...
    <section class="main-content-area">
        <div class="container">
            ...
            <form action="registerServlet" method="post" name=form>
                ...
                <h3>注册反馈：<jsp:getProperty name="userBean"  property="backNews" /> </h3>
                <div class="default-form-box">
                    <label>用户名称：</label>
                ...
                <div class="default-form-box">
                    <label>店铺名称：</label>
                    <jsp:getProperty name="userBean" property="storename"/>
                </div>
                <div class="default-form-box">
                    <label>地址：</label>
