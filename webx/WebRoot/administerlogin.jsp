...
<body>
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="shopadminister.jsp">管理商家</a></li>
                                        </ul>
                                    </li>
                                    <li class="last">
    ...
    <section class="main-content-area">
        <div class="container">
            ...
            <h3>管理员登录</h3>
            <form action="loginAdministerServlet" method="post">
                <div class="default-form-box">
                    <label>登录名称 <span>*</span></label>
                ...
                <div class="login_submit">
                    <button class="btn btn-md btn-black-default-hover mb-4" type="submit">登录</button>
               
                </div>
            </form>
            <h3>登录反馈信息：<jsp:getProperty name="loginaBean"  property="backNews" /> </h3>
            <div class="default-form-box">
                    <label>登录名称：</label>
                    <jsp:getProperty name="loginaBean" property="logname"/>
            </div>
            <!--login area start-->
            <!--register area start-->
