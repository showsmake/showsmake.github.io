...
<body>
    ...
    <section class="main-content-area">
        <div class="container">
            ...
            <h3>库存增加,目前支持上传的商品有笔记本，手机，背包等</h3>
            <form action="goodsAddServlet" method="post">
                ...
                <div class="default-form-box">
                    <label>商品 ID <span>*</span></label>
                    <input type="text" name="id">
                </div>
                <div class="login_submit">
                    <button class="btn btn-md btn-black-default-hover mb-4" type="submit">提交</button>
                </div>
            </form>
</div>
</section>
