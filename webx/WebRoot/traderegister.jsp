        ...
        <div class="container">
            ...
            <form action="registerTradeServlet" method="post" name=form>
                ...
                <div class="login_submit">
                    <button class="btn btn-md btn-black-default-hover" type="submit" name="g">提交</button>
                </div>
                </form>
                
                <h3>注册反馈：<jsp:getProperty name="usersBean"  property="backNews" /> </h3>
                <div class="default-form-box">
                    <label>商人名称：</label>
